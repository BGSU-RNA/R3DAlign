...
a=1;
Al(a).Name='Composite';
Al(a).SheetName='Composite';
a=a+1;
Al(a).Name='R3D Align';
Al(a).SheetName='Ryan';
a=a+1;
Al(a).Name='By Hand';
Al(a).SheetName='Jesse';
a=a+1;
Al(a).Name='ARTS';
Al(a).SheetName='ARTS';
a=a+1;
Al(a).Name='RyanNears';
Al(a).SheetName='RyanNears';
a=a+1;
% Al(a).Name='JAR3D';
% Al(a).SheetName='JAR3D';
% a=a+1;
% Al(a).Name='NW';
% Al(a).SheetName='NW';
...
for k = 1:length(Al)
    clear a;
    clear b;
    [a b]=xlsread('c:\rAlignmentBasePairComparison 1j5e 2avy',Al(k).SheetName);
   for i=1:length(b(:,2))
...
xlswrite('16S_alignment_data.xls',T);
