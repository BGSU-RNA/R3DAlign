function [] = rAlignmentSpreadsheet(File1,NTList1,File2,NTList2,AlignedNTList1,AlignedNTList2,SpreadsheetName)

if nargin < 7
    SpreadsheetName = 'Basepairs';
end
   ...
   for i=2:length(FinalListing)
      ...
      if ~isequal(FinalListing{i,k},' ')
        ...
        if ismac ~= 1
            ...
            fprintf('Excel functionality is not supported on Macs');
        end
   end
